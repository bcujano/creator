...
const BRUTO: ResultadoIA = {
  ...
  modulos_a_medida: [
    {
      codigo: 'MEDIDA_REACTIVACION',
      nombre: 'Agente de seguimiento y reactivación de pacientes',
      descripcion:
        'Es un agente que escribe por WhatsApp a pacientes que no vuelven hace meses y les ofrece agendar.',
      necesidad: 'La base histórica de pacientes no se trabaja.',
      entregables: ['Agente de reactivación por WhatsApp', 'Reporte de pacientes que regresan'],
      complejidad: 'media',
      por_que_complejidad: 'Segmentar la base por tiempo sin visita y conversar con cada paciente.',
      semanas: 2,
    },
  ],
  paquetes: [
    ...
    },
    {
      ...
      codigos: ['IAGENTE_WA', 'CRM_OPERATIVO', 'LLAMADAS', 'LEVANTAMIENTO', 'MEDIDA_REACTIVACION'],
...
export function documentoDePrueba(idioma: 'es' | 'en' = 'es'): Documento {
  ...
  return {
    ...
    cliente: {
      ...
      empleados: '9',
      notas: '',
      razon_social: 'Clínica Sonrisa Cía. Ltda.',
      direccion: 'Av. República de El Salvador N34-120, Quito',
      cedula_representante: '1712345678',
      crm_lead_id: null,
